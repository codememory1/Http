...
use Codememory\Http\Client\Exceptions\CookieException;
...
class InvalidCookieNameException extends CookieException
{
    ...
    #[Pure] public function __construct(string $chars)
    {
        ...
        parent::__construct(sprintf(
            'The cookie name must not contain the following characters: %s or perhaps the cookie name has not been set',
            $chars
        ));
